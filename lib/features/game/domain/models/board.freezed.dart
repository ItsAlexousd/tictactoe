...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Player?> cells)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Board() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Player?> cells)  $default,) {final _that = this;
switch (_that) {
case _Board():
return $default(_that.cells);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Player?> cells)?  $default,) {final _that = this;
switch (_that) {
case _Board() when $default != null:
return $default(_that.cells);case _:
  return null;
...
class _Board extends Board {
  const _Board({final  List<Player?> cells = const [null, null, null, null, null, null, null, null, null]}): _cells = cells,super._();
  

 final  List<Player?> _cells;
@override@JsonKey() List<Player?> get cells {
